...
/**
 * Abstracción del reloj del sistema para facilitar testing y formateo de fechas.
 *
 * - Por defecto usa el reloj del sistema (zona por defecto).
 * - Permite fijar un reloj (Clock.fixed) para pruebas y resetearlo.
 * - Es thread-safe para lectura; los setters son sincronizados.
 *
 * Ejemplos de uso:
 *   SystemClock clock = new SystemClock();
 *   LocalDateTime now = clock.now();
 *   String s = clock.nowFormatted("yyyy-MM-dd HH:mm:ss");
 *   clock.setFixed(LocalDateTime.of(2025, 1, 1, 0, 0), ZoneId.of("UTC"));
 *   clock.resetToSystemDefault();
 */
